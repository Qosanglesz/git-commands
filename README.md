...
6. In any project, there are some files and directories that you **should not** commit to git.    
   ...
   - Python cache: *.pyc , *.pyo , \_\_pycache__/
...
* https://www.w3schools.com/git/default.asp Git tutorial.
* https://youtu.be/X3bQzBhRMKQ Git tutorial playlist from YouTube KongRuksiam Official
